...
from vllm.transformers_utils.processors.fireredasr import (
...
class FireRedASRProcessingInfo(BaseProcessingInfo):
    ...
    def get_feature_extractor(self, **kwargs: object) -> FireRedASRFeatureExtractor:
        hf_processor = self.get_hf_processor(**kwargs)
        feature_extractor = hf_processor.feature_extractor  # type: ignore
        assert isinstance(feature_extractor, FireRedASRFeatureExtractor)
...
class FireRedASRForConditionalGeneration(
    ...
    def get_generation_prompt(
        ...
        if language is None:
            raise ValueError(
                "Language must be specified when creating the fireredasr prompt"
            )
