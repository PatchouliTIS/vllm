...
class FireRedASRFeatureExtractor(SequenceFeatureExtractor):
    r"""
...
class FireRedASRProcessor(ProcessorMixin):
    r"""
    Constructs a FireRedASR processor which wraps a FireRedASR feature extractor and
    a FireRedASR tokenizer into a single processor.
    ...
    feature_extractor_class = "FireRedASRFeatureExtractor"
